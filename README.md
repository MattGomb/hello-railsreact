...
This project is a first-try of combining rails with react. It has one basic function, which gives us a random string out of five (or as many as we input)
...
```sh
  cd my-folder
  git clone git@github.com:MattGomb/hello-railsreact.git
```
